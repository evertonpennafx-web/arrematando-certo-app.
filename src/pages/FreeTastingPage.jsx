...
const FreeTastingPage = () => {
  ...
  useEffect(() => {
    ...
    const baseUrl = import.meta.env.VITE_SUPABASE_URL ? import.meta.env.VITE_SUPABASE_URL.replace(/\/$/, '') : '';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (formData.file) {
         ...
         pdfUrl = await uploadPdfToStorage(formData.file, 'free_preview_files');
      }
      ...
      // Submit via Edge Function (no direct inserts)
      ...
      // Extract fields from direct response object
      // Some Edge Functions might return snake_case (access_token) or camelCase depending on implementation. 
      // We check for access_token with fallback to token.
      ...
      // Small delay for user to see success toast
      ...
      // Explicit error handling with Toast
      toast({
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content="Solicite um preview gratuito da análise do seu edital de leilão." />
      </Helmet>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-2xl">
                Conheça a qualidade da nossa análise sem custo. Envie seu edital e receba um preview técnico com pontos essenciais.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-black/90 backdrop-blur-md p-6 rounded-xl border border-[#d4af37] shadow-[0_0_20px_rgba(212,175,55,0.1)]">
                <h3 className="text-xl font-bold mb-4 text-[#d4af37] border-b border-[#d4af37]/30 pb-2">O que você vai receber:</h3>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">
                      Este preview é apenas uma leitura inicial. A análise completa de riscos, ônus e checklist detalhado está disponível apenas nos planos pagos.
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="bg-black/95 backdrop-blur-sm p-8 rounded-2xl border border-[#d4af37] shadow-[0_0_30px_rgba(212,175,55,0.15)]">
                  ...
                  <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <h4 className="font-bold text-red-800 text-sm mb-1">❌ Erro ao processar solicitação</h4>
                        ...
                        <p className="text-xs text-red-500 mt-2 border-t border-red-200 pt-2">
                          Se o problema persistir, verifique o console (F12) para mais detalhes técnicos.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="mb-8 p-6 bg-black border border-[#d4af37]/30 rounded-xl">
                  <h3 className="text-sm font-bold text-[#d4af37] mb-4 uppercase tracking-wider">Documentação (Escolha uma opção)</h3>

...
export default function SubmissionPage() {
  ...
  // ✅ PIXEL: PageView em SPA ao entrar nessa rota (seguro e não muda nada)
  useEffect(() => {
    try {
  ...
  async function handleSubmit(e) {
    ...
    // ✅ PIXEL EVENTS (SÓ ACRESCENTADO, NÃO ALTERA FLUXO)
    try {
      if (window.fbq) {
        // Lead gerado (form submetido)
        window.fbq("track", "Lead");
        // Iniciou checkout (vai para Kiwify)
        window.fbq("track", "InitiateCheckout", { plan: effectivePlan });
        // Custom para identificar plano
